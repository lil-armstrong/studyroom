                            ...
                            <div class="bordered-dark  pad-xs bg-white">
                                ...
                                <div class=" pad-xs bg_tint_light ">
                                    ...
                                    <div class="list-group">
                                        ...
                                        echo "<span class=\"list-group-item \"><strong class='text-muted'><i class=\"fa fa-birthday-cake\">&ensp;</i>Date of birth: " . $details[0]['dob'] . "</span></span>";
                                        echo "<span class=\"list-group-item \"><strong class='text-muted'><i class=\"fa fa-home\">&ensp;</i>Department: <span class='text-info'>" . ucfirst(shorten($user->getDept(), 10)) . "&nbsp;</span><a href='#popup_editdept' data-toggle='modal' title='Meet others'><i class='fa fa-pencil'></i></a><a href='dept/" . strtolower($details[0]['field']) . "' title='Meet others'><i class='fa fa-binoculars'></i></a></span></span>";
